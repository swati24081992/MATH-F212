...
|Mod 09| Generative Models & <br> Unsupervised Learning  | Gaussian mixture models  <br> GMM (with EM) <br> k-means clustering <br> PCA | [Lecture 21](Lectures/Lecture21.pdf)  <br>  [Lecture 22](Lectures/Lecture22.pdf) <br>  [Lecture 23](Lectures/Lecture23.pdf) <br>  [Lecture 24](Lectures/Lecture24.pdf)| <br> [AL] Sections 10.1 <br> [AL] Sections 10.1  |
